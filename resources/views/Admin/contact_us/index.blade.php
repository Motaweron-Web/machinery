...
@section('title')
    {{($setting->title) ?? ''}} | Messages
@endsection
@section('page_name') Messages @endsection
@section('content')
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"> Messages {{($setting->title) ?? ''}}</h3>
{{--                    <div class="">--}}
...
{{--                    </div>--}}
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped table-bordered text-wrap w-100" id="dataTable">
                            ...
                            <tr class="fw-bolder text-muted bg-light">
                                ...
                                <th class="min-w-50px">Full Name</th>
                                ...
                                <th class="min-w-125px">Message Date</th>
        ...
        <div class="modal fade" id="editOrCreate" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="example-Modal3">Contact Us data</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
@section('ajaxCalls')
    <script>
        ...
        // Delete Using Ajax
        deleteScript('{{route('contact.delete')}}');
        // Add Using Ajax
