    ...
    <div class="container-fluid">
        <div class="d-flex">
            <a class="header-brand d-md-none" href="#">
                <img src="{{asset('assets/web/img/logo.png')}}" class="header-brand-img mobile-icon" alt="logo">
                <img src="{{asset('assets/web/img/logo.png')}}" class="header-brand-img desktop-logo mobile-logo" alt="logo">
            </a>
                ...
                <div class="dropdown profile-1">
                    ...
                    <div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow">
                        <a class="dropdown-item" href="{{route('myProfile')}}">
                            <i class="dropdown-icon mdi mdi-account-outline"></i> Account
                        </a>
{{--                        <a class="dropdown-item" href="#">--}}
{{--                            <i class="dropdown-icon  mdi mdi-settings"></i> Account Setting--}}
{{--                        </a>--}}
