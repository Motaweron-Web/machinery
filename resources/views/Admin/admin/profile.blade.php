...
{{--                                <h6 class="text-muted mb-4"> {{ \Carbon\Carbon::parse($admin->created_at)->diffForHumans() }}</h6>--}}
                            ...
                            <div id="profile-log-switch">
                                ...
                                <div class="table-responsive ">
                                    <table class="table row table-borderless">
                                        ...
                                        <tbody class="col-lg-12 col-xl-4 p-0">
                                        <tr>
                                            <td><strong>Register Date :</strong> {{ \Illuminate\Support\Carbon::parse($admin->created_at)->diffForHumans() }}</td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
