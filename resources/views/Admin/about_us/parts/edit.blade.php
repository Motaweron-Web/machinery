<div class="modal-body">
    ...
    @csrf
        ...
        <textarea type="text" class="form-control editor" name="description_it" id="description_ar">{{$abouts->description_it}}</textarea>
        </div>
        <div class="form-group">
            <label for="name" class="form-control-label">Description EN</label>
            <textarea type="text" class="form-control editor" name="description_en" id="description_en">{{$abouts->description_en}}</textarea>
        </div>
