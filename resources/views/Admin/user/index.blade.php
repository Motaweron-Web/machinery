    ...
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p>Registered users of the site</p>
                    <div class="">
        ...
        <div class="modal fade bd-example-modal-lg" id="editOrCreate" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="example-Modal3">User Data</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
@section('ajaxCalls')
    <script>
        ...
        showData('{{route('user.index')}}', columns);
        // Delete Using Ajax

        deleteScript('{{route('user.delete')}}');

        // Add Using Ajax
        showAddModal('{{route('user.create')}}');
        addScript();



        // Edit Using Ajax
        showEditModal('{{route('user.edit',':id')}}');
        editScript();
    </script>
@endsection
