<div class="modal-body">
    ...
    @csrf
        ...
        <div class="form-group">
            ...
            <textarea type="text" class="form-control editor" name="desc_en" id="name_en" >{{ $products->desc_en }}</textarea>
        </div>
        <div class="form-group">
            <label for="name" class="form-control-label">desc it</label>
            <textarea type="text" class="form-control editor" name="desc_it" id="name_en" >{{ $products->desc_it }}</textarea>
        </div>
        <div class="form-group">
